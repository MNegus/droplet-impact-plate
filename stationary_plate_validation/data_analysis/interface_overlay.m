...
master_directory = '/scratch/Plate_validation_data/raw_data/';

% Names of the individual directories where the data is stored
data_directories = ["plate_alignment_0", "plate_alignment_2", ...
    "plate_alignment_4", "wall_data"];
...
legend_entries = ["Full alignment", "Half alignment", ...
    "Quarter alignment", "Solid wall"];

dir_arr = [1, 2, 3, 4]; % Specifies which directories to plot
