...
legend_entry = sprintf("Cantilever");
...
xlabel("t");
ylabel("Force");
print(gcf, sprintf('%s/Figures/force.png', analysis_directory) ,'-dpng','-r300');

%% Plate displacement
% Plots the displacement of the plate, s(t)
ts = log_matrix(:, 1);
displacements = log_matrix(:, 4);
figure(5);
plot(ts, displacements);
xlabel("t");
ylabel("s(t)");
title("Displacement");
print(gcf, sprintf('%s/Figures/displacement.png', analysis_directory) ,'-dpng','-r300');
