...
const double HARD_MAX_TIME = 0.6; // Hard maximum time 
const double REMOVAL_DELAY = 0.0; // Time after pinch-off to start removal
const int AVG_FORCE_NO = 1; // Number of timesteps to average the force over
...
const double PEAK_THRESHOLD = 1.0; // Number of std devs away from mean
const double PEAK_INFLUENCE = 0.1; // Influence weighting from peak data
const double PEAK_DELAY = 0.01; // Delay before peak detection starts
