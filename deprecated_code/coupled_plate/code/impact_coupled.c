...
double plate_vel = 0.; // Velocity of plate, equal to -s'(t)
double plate_position = INITIAL_PLATE_TOP; // x position of plate 
...
/* Removes any small droplets that have formed, that are smaller than
    a specific size */
