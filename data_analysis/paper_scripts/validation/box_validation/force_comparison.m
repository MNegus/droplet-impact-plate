...
parent_directory = '/mnt/newarre/cantilever_paper_data/validation_alpha_100/box_width_validation/';
...
data_directories = ["box_width_3", "box_width_6", "box_width_12", "box_width_24"];
...
legend_entries = ["Box width = 3", "Box width = 6", "Box width = 12", "Box width = 24"];
